...
description: "Step-by-step guide to installing the .NET SDK and running EnglishMatrix on Windows, macOS, or Linux — no NuGet packages or configuration required."
---
