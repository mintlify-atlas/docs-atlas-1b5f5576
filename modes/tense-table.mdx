---
title: "Full Tense Conjugation Table for Any English Verb"
sidebarTitle: "Tense Table"
description: "Menu option 9 displays a complete 7-tense conjugation table for any verb in the dictionary, showing English forms for I, She/He, and We alongside Spanish equivalents."
---
...
The tense table relies on the `conjugaciones` dictionary, which contains pre-built Spanish conjugation data for approximately **134 verbs** as of v9. If you enter a verb that is not in the dictionary, EnglishMatrix displays:
